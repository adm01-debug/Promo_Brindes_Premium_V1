...
| Push e pull request | Gates dependiam de execução manual | Workflow versionado executa instalação limpa, tipos, plano, build, scanner, orçamento, cenários e matriz Chromium/Firefox/WebKit | `.github/workflows/quality.yml`; a [matriz tripla passou no CI remoto](https://github.com/adm01-debug/Promo_Brindes_Premium_V1/actions/runs/35740802785). |
