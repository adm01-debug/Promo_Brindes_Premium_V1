...
O workflow de CI executa instalação limpa, esses gates, cenários isolados e a matriz Chromium/Firefox/WebKit com um worker em push e pull request. `actionlint` validou a sintaxe localmente; tipos, plano, build, 57 cenários, 70 contratos e as 213 execuções E2E passaram no [run remoto 35791611910](https://github.com/adm01-debug/Promo_Brindes_Premium_V1/actions/runs/35791611910). O rebuild com onze migrations, 64 contratos pgTAP, concorrência e lint passou no [run 35791611794](https://github.com/adm01-debug/Promo_Brindes_Premium_V1/actions/runs/35791611794). [Matriz e correções](audit/2026-09-22-browser-matrix.md); [conferência pré-briefing](audit/2026-09-22-selection-freshness.md); [vigência e cache em produção](audit/2026-09-22-catalog-publication-window.md); [ambiente Vercel e catálogo canônico](audit/2026-09-22-production-environment.md).
