...
O workflow de CI executa instalação limpa, esses gates, cenários isolados e a matriz Chromium/Firefox/WebKit com um worker em push e pull request. `actionlint` validou a sintaxe localmente; as 213 execuções ampliadas foram aprovadas no [run remoto 35788063173](https://github.com/adm01-debug/Promo_Brindes_Premium_V1/actions/runs/35788063173), e o rebuild com 58 contratos pgTAP, concorrência e lint passou no [run 35788063234](https://github.com/adm01-debug/Promo_Brindes_Premium_V1/actions/runs/35788063234). [Matriz e correções](audit/2026-09-22-browser-matrix.md); [conferência pré-briefing](audit/2026-09-22-selection-freshness.md); [ambiente Vercel e catálogo canônico](audit/2026-09-22-production-environment.md).
