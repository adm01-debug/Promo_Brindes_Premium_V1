...
| Origem externa ou abuso automatizado | Spam, exfiltração ou sobrecarga | Verificação de origem, limite distribuído no banco quando a entrega está ativa, timeout e CSP | Validar proxy, WAF, logs e modelo de ameaça aprovado |
