...
| Várias réplicas  | Memória perdida em reinício ou divergente entre pods      | Idempotência no banco sobrevive ao processo; rate limit ainda precisa ser distribuído | Backend + SRE                  |
